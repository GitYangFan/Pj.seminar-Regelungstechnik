...
#ifndef SERIALIB__SERIALIB_H_
#define SERIALIB__SERIALIB_H_
...
// This is MinGW special case
    #include <sys/time.h>  // NOLINT(build/include)
#else
...
public:
  ...
  // Open a device
  char openDevice(
    const char * Device, const unsigned int Bauds,
