...
// Project seminar
// Initial values for pose initialized
// latest_pose_ gives the pose that should be sent to Hamster
  bool first_pose_received_=false;
  double initial_x_=0.0;
  double initial_y_=0.0;
  double initial_yaw_=0.0;

  TrajectoryUtils::VehiclePose latest_pose_;
  ...
  /** Callback function for the Float64MultiArray subscription */
